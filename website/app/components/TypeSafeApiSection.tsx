    ...
    <section className="p-10">
      ...
      <div className="flex flex-col gap-5">
        ...
        <p>
          ...
          allowing you to concentrate on building your app. And the best part:
          It&apos;s complete type-safe.
        </p>
        <p>
          Content Collections will infer the types of your collections from your
          configuration. Enjoy the intelisense from your ide and be sure that
          you are using the right properties. The inferred types making

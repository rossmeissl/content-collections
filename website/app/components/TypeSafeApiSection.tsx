...
function TsLogo() {
  return (
    <svg fill="none" viewBox="0 0 512 512" className="w-24 h-24 mt-5 mx-auto">
      ...
      <Content className=" grid grid-cols-1 md:grid-cols-2 items-center gap-10">
        <div className="flex flex-col gap-5">
          ...
          <p>
            ...
            API, allowing you to concentrate on building your app. And the best
            part: It&apos;s complete type-safe.
          </p>
          <p>
            Content Collections will infer the types of your collections from
            your configuration. Enjoy the intelisense from your ide and be sure
            that you are using the right properties. The inferred types making
